...
public class ViewMoreEnglish extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DictionaryEntitty dict =  Dictionary.myDB.getDetailEng(id);
        if(dict!=null) {
        ...
        tv_word2.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                copyToClipboard(ViewMoreEnglish.this,dict.getDefinition());
        ...
        btn_copy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                copyToClipboard(ViewMoreEnglish.this,dict.getWord1());
                Toast.makeText(getApplicationContext(),"Text copied to clipboard",Toast.LENGTH_SHORT).show();
            }
        });
